...
/*!
    UR5State is an implementation of the DeviceState virtual class for UR5 robots.
*/
class UR5State : public DeviceState
{
    public:
...
/*!
    UR5Interface is an implementation of the RobotInterface virtual class for UR5 robots.
    This interface is designed to receive state messages from the custom UR5 controller included with this framework.
*/
class UR5Interface : public RobotInterface
{
    public:
        UR5Interface(ros::NodeHandle handle, std::string robot_type);

        // Covariant return type.
        const UR5State& get_state();
